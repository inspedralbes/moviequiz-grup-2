...
<footer class="page-footer">
    ...
    <div class="row">
      ...
      <div class="col l4 offset-l2 s12">
        ...
        <ul>
          ...
          <li><i class="material-icons prefix">person_outline</i><a class="grey-text text-lighten-3" href="">a19axechacan@inspedralbes.cat</a></li>
        </ul>
      </div>
    </div>
  </div>
  <div class="footer-copyright">
    <div class="container">
    Copyright © 2021 Ins Pedralbes. Tots els drets reservats.
    <a class="grey-text text-lighten-4 right" href="">Grup 2</a>
    </div>
  </div>
</footer>